...
<div class="about flex flex-col lg:flex-row lg:space-x-16 xl:space-x-32 space-y-8 lg:space-y-0 items-center">
    ...
    <div class="about-text flex xl:flex-col flex-wrap">
        ...
        <a href="{{route('anggota-daur')}}" class="w-full lg:w-[80%] py-2 lg:py-3 lg:px-8 font-medium text-center text-base lg:text-lg bg-slate-50 hover:bg-[#FF8833] border-2 border-[#FF8833] text-[#FF8833] hover:text-neutral-50 rounded-3xl transition ease-in-out delay-150 hover:scale-110 duration-300">
            Mulai Daur Ulang
        </a>
    </div>
</div>
<div class ="my-4">
    <div class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-3 md:gap-4 mt-8">
        <div class="flex flex-col col-span-1">
            <div class="my-2 flex-wrap text-center items-center p-4 md:p-8 border border-gray-200 rounded-lg shadow-md space-y-4">
        ...
        <div class="col-span-2 overflow-x-auto text-xs md:text-sm ">
