...
@section('content')
    <div class="w-full max-w-sm mx-auto">
        ...
        <form action = "{{route('login.post')}}" method="POST" class="bg-[#FF8833] max-h-full rounded-3xl px-8 pt-8 pb-8 mb-4">
            @csrf
            ...
            <div class="relative">
                ...
                <div class="mb-6">
                    <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" id="email" name="email" type="text" placeholder="Email">
                </div>
            </div>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                ...
                <div class="mb-2" x-data="{ show: true }">
                    <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" name="password" id="password" type="password" placeholder="Kata Sandi":type="show ? 'password' : 'text'">
