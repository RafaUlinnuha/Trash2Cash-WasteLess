<div class="mt-8 flex-row flex-wrap items-center h-64 lg:h-72 xl:h-80 pb-6 px-2 pt-6 md:pt-10 bg-white border border-gray-200 rounded-lg transition ease-in-out delay-150 hover:scale-105 duration-300 shadow-md">
