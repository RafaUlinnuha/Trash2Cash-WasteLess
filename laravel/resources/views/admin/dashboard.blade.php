            ...
            <div class="rounded-t mb-0 px-0 border-gray-200">
                <div class="flex flex-wrap items-center px-4 py-2">
                    ...
                    <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                        <button class="bg-[#6C894A] dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">See all</button>
                    </div>
                </div>
            ...
            <div class="rounded-t mb-0 px-0 border-gray-200">
                ...
                <table class="items-center w-full bg-transparent border-collapse">
                    ...
                    @forelse ($order as $item)
                        <tr class="text-gray-700 dark:text-gray-100">
                            <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">1</td>
                            <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">13/12/2013</td>
                            <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">setor-813814</td>
                            <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">Rp 5.000,00</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class = "text-center text-xs text-gray-600 p-4">
