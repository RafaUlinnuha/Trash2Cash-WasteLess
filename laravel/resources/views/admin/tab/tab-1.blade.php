<div x-show="current === 1" class="text-center mt-2 md:mt-4">
    ...
    <table class="w-full text-xs md:text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr>
                ...
                @if($item->pembayaran->status == 'belum_bayar')
                <td class="px-3 py-4 text-center">Belum Bayar'</td>
                @elseif($item->pembayaran->status == 'menunggu')
                <td class="px-3 py-4 text-center">Menunggu Konfirmasi'</td>
                @elseif($item->pembayaran->status == 'selesai')
                <td class="px-3 py-4 text-center">Selesai</td>
                @elseif($item->pembayaran->status == 'batal')
                <td class="px-3 py-4 text-center">batal</td>
                @endif
