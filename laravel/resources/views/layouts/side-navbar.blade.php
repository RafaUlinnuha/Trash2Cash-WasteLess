...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 order-2">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{route($user->role == 'anggota'? 'anggota-home':'bank-status')}}" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('img/logo orange.png') }}" class="h-10 hidden lg:block">
                </a>
            </div>
        </div>
    </div>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   ...
   <div class="flex flex-col items-center my-6">
            @if($user->foto_profil == null)
                <span class="i-bi-people-circle w-12 h-12 md:w-24 md:h-24 text-gray-600"></span>
                <!-- kl ada foto profil -->
                @else
                <img src="{{asset('storage/foto_user/'.$user->foto_profil)}}" alt="" class="w-12 h-12 md:w-24 md:h-24 rounded-full">
            @endif            
        ...
        <ul class="space-y-2 font-medium">
            ...
            <!-- USER ROLE ANGGOTA -->
            <li>
                <a href="{{route('anggota-home')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('anggota-daur')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('anggota-status')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('anggota.pendapatan')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('bank-status')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('penjualan.view')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{ route('ordertoko.view') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('pendapatan.view')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <!-- USER ROLE ADMIN -->
            <li>
                <a href="{{route('admin.dashboard')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('admin.user')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('admin.order')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{route('admin.penyetoran')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            @endif
            <li>
                <a href="{{ route('profil.view') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group
            ...
            <li>
                <a href="{{ route('logout.post') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
