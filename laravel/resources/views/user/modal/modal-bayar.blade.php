<button data-modal-target="#bayar-modal{{$order->pembayaran->id}}" data-modal-toggle="bayar-modal{{$order->pembayaran->id}}" class="block text-white bg-[#8092C1] hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
  Bayar Sekarang
</button>
