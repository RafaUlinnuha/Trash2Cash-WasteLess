<!-- Modal toggle -->
<button data-modal-target="edit-modal{{$rekening->id}}" data-modal-toggle="edit-modal{{$rekening->id}}" class="block text-white bg-blue-600 hover:bg-blue-700 focus:outline-none font-medium rounded-lg text-xs md:text-sm px-2 py-2 md:px-5 md:py-2.5 text-center" type="button">
    Edit
</button>
