...
<?php $jumlah=0 ?>
    <div class="shop-2">
      <div class="flex space-x-4 items-center">
        ...
        <h1 class="items-center mx-auto p-2 text-sm font-medium text-center text-white bg-[#8092C1] rounded-lg">belum bayar</h1>        
        ...
        @else
        <h1 class="items-center mx-auto p-2 text-sm font-medium text-center text-white bg-[#8092C1] rounded-lg">{{$order->status}}</h1>        
        @endif  
    </div>
    </div>
    <div class="m-4">
