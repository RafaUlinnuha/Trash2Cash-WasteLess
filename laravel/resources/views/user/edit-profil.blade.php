...
@section('content')
    ...
    <div class="data border-2 py-8 px-12 shadow mt-12">
        ...
        <div class="space-y-4 mt-4">
            ...
            <div class="flex justify-between">
                ...
                <div class="w-2/3">
                    <textarea class="w-full pt-2 px-3 text-base placeholder-gray-600 border rounded-lg " type="textarea" placeholder="Alamat sebelumnya" cols="30" rows="3"></textarea>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-2 mt-12 gap-12">
        ...
        <div class="data border-2 py-8 px-12 shadow">
            <h1 class="text-2xl font-medium">Tambah Bank</h1>
            <hr class="mt-2">
            <div class="space-y-4 mt-4">
                <div class="flex justify-between items-center">
