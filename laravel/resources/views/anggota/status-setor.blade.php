...
@section('content')
<h1 class="mt-8 text-xl md:text-2xl lg:text-4xl  font-semibold text-center md:text-left">Status Penyetoran</h1>
<div x-data="{ current: 1 }">
  ...
  @include('anggota.tab-status.tab-1')
  @include('anggota.tab-status.tab-2')
  @include('anggota.tab-status.tab-3')
</div>
