...
@section('content')
<h1 class="text-xl md:text-2xl lg:text-4xl font-semibold text-center md:text-left">Pendapatan</h1>
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
    <div class="col-span-2 flex-row flex-wrap text-center items-center p-4 md:p-8 border border-gray-200 rounded-lg shadow-md space-y-4">
