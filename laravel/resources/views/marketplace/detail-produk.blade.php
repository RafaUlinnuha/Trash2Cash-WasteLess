...
@section('content')
    <nav class="flex flex-wrap pb-8" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{ route('kategori', ['kategori_slug' => $produk->kategoriSampah->slug])}}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{$produk->kategoriSampah->nama}}</a>
            </div>
        </li>
