...
@section('content')
    ...
    <div class="flex space-x-24 mt-8">
        <img src="{{ asset('img/marketplace/produk-2.png') }}" class="">
        <div class="deskripsi">
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos accusamus fugit deserunt nam rerum soluta quo molestias laudantium, possimus eius minima unde! Quo illo architecto sed facilis ad natus minus!</p>
            ...
            <div>
                <button class="items-center mt-6 py-2 px-8 bg-[#FF8833] text-neutral-50 rounded-lg">Beli Sekarang</button>
                <button class="items-center mt-6 py-2 px-8 border border-[#FF8833] text-[#FF8833] rounded-lg">Keranjang</button>
            </div>
        </div>
    </div>
@endsection 